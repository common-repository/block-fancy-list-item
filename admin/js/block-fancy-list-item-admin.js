...
addFilter('blocks.registerBlockType', 'advgb/registerExtraListAttrs', function (settings, name) {
...
addFilter('editor.BlockEdit', 'advgb/customListStyles', function (BlockEdit) {
    return function (props) {
        if (props.name === 'core/list') {
            ...
            return [wp.element.createElement(BlockEdit, _extends2({ key: 'block-edit-custom-separator' }, props)), wp.element.createElement(
                InspectorControls,
                null,
                ...
                icon && icon !== '' && wp.element.createElement(
                    'style',
                    null,
                    '#block-' + clientId + ' li:before {\n                                content: "' + content + '";\n                                font-family: dashicons;\n                                font-size: ' + iconSize + 'px;\n                                color: ' + iconColor + ';\n                                line-height: ' + lineHeight + 'px;\n                                margin: ' + margin + 'px;\n                                padding: ' + padding + 'px;\n                            }\n                            #block-' + clientId + ' li div.block-editor-rich-text__editable {\n                                display: inline-block;\n                            }'
                )
            )];
        }
